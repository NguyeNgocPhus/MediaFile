...
namespace MediaFile.Databases.Migrations
{
    ...
    [Migration("20231205110027_init_tb")]
    partial class init_tb
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MediaFile.Domain.MediaFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("MediaFile.Domain.MediaFolder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MediaFile.Domain.MediaFile", b =>
                {
                    b.HasOne("MediaFile.Domain.MediaFolder", "MediaFolder")
                        .WithMany("MediaFiles")
